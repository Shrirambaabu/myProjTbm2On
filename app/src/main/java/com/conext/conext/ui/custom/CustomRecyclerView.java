...
public class CustomRecyclerView extends RecyclerView {
    ...
    private void configure(@Nullable AttributeSet attrs) {
        ...
        TypedArray typedArray = getContext().getTheme().obtainStyledAttributes(
                attrs,
                com.abed.hexagonrecyclerview.R.styleable.HexagonRecyclerView,
                0, 0);

        float horizontal_spacing = typedArray.getDimension(com.abed.hexagonrecyclerview.R.styleable.HexagonRecyclerView_items_horizontal_spacing, 0.0f);
        float vertical_spacing = typedArray.getDimension(com.abed.hexagonrecyclerview.R.styleable.HexagonRecyclerView_items_vertical_spacing, 0.0f);
        final int row_size = typedArray.getInt(com.abed.hexagonrecyclerview.R.styleable.HexagonRecyclerView_items_count_in_row, 2);
        final int orientation = typedArray.getInt(com.abed.hexagonrecyclerview.R.styleable.HexagonRecyclerView_orientation, 0);
        typedArray.recycle();
        ...
        vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                ViewTreeObserver obs = CustomRecyclerView.this.getViewTreeObserver();
